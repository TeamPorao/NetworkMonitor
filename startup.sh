...
(crontab -l ; echo "*/2 * * * * sudo /usr/bin/python3 /home/nine/Downloads/Challenge_FINAL/preprocess.py") | crontab -
# Schedule yara_analyzer.py to run every 2 minutes using cron
(crontab -l ; echo "*/2 * * * * sudo /usr/bin/python3 /home/nine/Downloads/Challenge_FINAL/yara_analyzer.py") | crontab -
